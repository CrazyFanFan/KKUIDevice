#
#  Be sure to run `pod spec lint KKUIDevice-swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "kkk"
  # s.authors            = { "kkk" => "kongkk@fxiaoke.com" }
  # s.social_media_url   = "http://twitter.com/kkk"
